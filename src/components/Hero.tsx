...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center pt-18 pb-8 sm:pt-18 sm:pb-12 lg:pt-20 lg:pb-16 bg-gradient-to-br from-secondary-50 via-white to-secondary-50 white-wall-texture tech-pattern-elegant subtle-texture-base tech-overlay tech-overlay-enhanced tech-shine overflow-hidden relative"
    >
